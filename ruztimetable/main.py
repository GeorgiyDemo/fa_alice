...
def main():
    ...
    elif "Что ты умеешь" in user_command:
        string = "Я могу подсказать тебе расписание Финансового Университета на сегодня, завтра и послезавтра. Для этого скажи 'сегодня', 'завтра' или 'послезавтра'"
        out_dict = UtilClass.json_generator(string)
